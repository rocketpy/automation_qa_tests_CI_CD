...
#  py.test file_name.py -v --assert=‘plain’ --alluredir report name_dir_for_report

#  allure generate /root/Pycharm/tests_pytest/report -o /root/Pycharm/tests_pytest/report #  here we find index.html with report after tests
